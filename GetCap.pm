...
WWW::Bilibili::GetCaption - Save the YouTube closed captions as .srt files for a videoID.

=head1 SYNOPSIS

    use WWW::Bilibili::GetCaption;

    my $yv_cap = WWW::Bilibili::GetCaption->new(%opts);
